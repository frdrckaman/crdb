...
class Email {
    ...
    function __construct(){
        $this->_smtpEmail = 'frdrckjoseph@gmail.com';
        $this->_smtpHost = 'smtp.gmail.com';
        $this->_smtpUsername = 'frdrckjoseph@gmail.com';
        $this->_smtpPassword = 'elinipahenry1';
        $this->_smtpaddCC = 'Stephen.Mtenga@crdbbank.co.tz';
        $this->_website = 'www.company.com';
        $this->_info = 'info@company.com';
        $this->_project = 'COMPANY';
    ...
    function emailConf($email,$subject,$body){
        ...
        $mail->setFrom($this->_smtpUsername,$this->_project.' SALE AGENCY SERVICES');
...
//        $mail->addCC($this->_smtpaddCC);
                        ...
                        <td class="container" bgcolor="#FFFFFF">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table align="" style="padding: 20px">
                                            <tr>
                                                <td align="right"><h3 class="collapse" style="font-weight: bolder">'.$this->_project.' SALE AGENCY SERVICES</h3></td>
                                            </tr>
                                        </table>
                                        <!-- /column 1 -->
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$name.'</h3>Your Subscription have been'.$subject.' .</p>
                                            <!-- /Callout Panel -->
    ...
    function sendCom($email,$name,$subject){
        $body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml" >
            <head>
                <!-- If you delete this meta tag, Half Life 3 will never be released. -->
                        ...
                        <td class="container" bgcolor="#FFFFFF">
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$name.'</h3> Your Subscription have been approved .</p>
                                            <!-- /Callout Panel -->
